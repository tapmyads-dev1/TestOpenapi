...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("apiKeyHeader", new ApiKeyAuth("header", "Ocp-Apim-Subscription-Key"));
    INSTANCE.authentications.put("apiKeyQuery", new ApiKeyAuth("query", "subscription-key"));
